...
Define how the internal local HTTP server is started and managed by `M3U8Manager`, ensuring users interact only with the high-level API without needing to manage server lifecycle directly.
