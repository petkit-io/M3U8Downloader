...
Allow users to inject a custom logging implementation into the M3U8 library, controlling how and where log output is directed. The library exposes a typed `M3U8Logger` interface and routes all internal log calls through it.
